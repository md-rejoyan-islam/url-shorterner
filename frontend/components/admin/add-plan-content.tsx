...
import { useCreatePlanMutation } from "@/store/api/plan-api";
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description="Add a new subscription plan to your platform"
        actions={
          <Button
            asChild
            variant="outline"
                ...
                {featuresList.length > 0 ? (
                  ...
                  <div className="text-center py-6 border rounded-lg border-dashed">
                    <p className="text-sm text-muted-foreground">
                      No features added yet. Add features above to display them
                      on the pricing card.
                    </p>
                  </div>
                )}
